...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      <a class="navbar-brand" href="index.php">Kantilal Bank India</a>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3 style="font-size:70px;  color:white;">Welcome to</h3>
                  <h1 style="font-size:100px;color:blue;">KBI</h1>
                  <p style="font-size:50px;color:Pink;">Don't share OTP to anyone!</p>
                </div>
              </div>
